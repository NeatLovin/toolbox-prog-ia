...
| `AUDIT_DAILY_CAP_REVIEW_DATE` | Date au-delà de laquelle le Worker signale (jamais ne modifie) que le plafond ci-dessus mérite d'être révisé | `2026-10-06` (14 jours après l'envoi du lien aux 22 enseignants, 2026-09-22) |
